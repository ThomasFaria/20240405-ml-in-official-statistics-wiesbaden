...
## Case-study : From training to deployment
...
## Case-study : Serving a ML model as an API
...
## Case-study : Monitoring a ML model
...
## Case-study : Quality control in production
...
- Organizational challenges
  ...
  - Transitioning towards an pen-source governance

## Conclusion

- In the era of data science, methodology and IT must come forward together

- Onyxia ore freedom to deal with the organizational challenges
