...
- Statisticians are increasingly trained in [**data science**]{.orange}
  - But limited by [**IT environments**]{.blue2}
...
- Availability of [**development environments**]{.orange}
  - [**Flexibility**]{.blue2} to experiment readily
...
- [**Onyxia**]{.orange} : fostering autonomy through cloud-native technologies
  - Reference platform for the [**one-stop-shop (AIML4OS WP3)**]{.blue2}

- Goal of this talk : [**feedback**]{.orange} of Insee
  - How we made [**cloud-technologies**]{.blue2} accessible to statisticians
  - How it was instrumental in putting [**ML in production**]{.blue2}
